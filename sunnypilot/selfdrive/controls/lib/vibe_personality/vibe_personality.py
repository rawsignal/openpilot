...
MIN_ACCEL_PROFILES = {
  LongPersonality.relaxed:    [-.08, -1.10],  # gentler braking
  LongPersonality.standard:   [-.10, -1.20],  # normal braking
  LongPersonality.aggressive: [-.12, -1.30],  # more aggressive braking
}
