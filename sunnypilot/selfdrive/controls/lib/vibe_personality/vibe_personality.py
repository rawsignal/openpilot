...
MIN_ACCEL_PROFILES = {
  LongPersonality.relaxed:    [-1.10, -1.10],  # gentler braking
  LongPersonality.standard:   [-1.20, -1.20],  # normal braking
  LongPersonality.aggressive: [-1.30, -1.30],  # more aggressive braking
}
