...
MIN_ACCEL_PROFILES = {
  LongPersonality.relaxed:    [-.08, -.08, -.1, -.5, -1.10],  # gentler braking
  LongPersonality.standard:   [-.09, -.09, -.2, -.6, -1.20],  # normal braking
  LongPersonality.aggressive: [-.10, -.10, -.3, -.7, -1.30],  # more aggressive braking
}
