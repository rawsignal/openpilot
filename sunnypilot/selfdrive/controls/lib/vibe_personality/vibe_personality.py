...
MIN_ACCEL_PROFILES = {
  LongPersonality.relaxed:    [-.08, -.3, -1.10],  # gentler braking
  LongPersonality.standard:    [-.10,  -.4, -1.20],  # normal braking
  LongPersonality.aggressive: [-.12, -.5, -1.30],  # more aggressive braking
}
MIN_ACCEL_BREAKPOINTS =       [0., 8.3,  50.]
