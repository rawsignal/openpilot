...
from tinygrad.sunnypilot.modeld_v3.helpers import PROFILE, from_mv, getenv, to_mv, round_up
from tinygrad.sunnypilot.modeld_v3.renderer import Renderer
from tinygrad.sunnypilot.modeld_v3.device import BufferSpec, Compiler, Compiled, LRUAllocator, ProfileRangeEvent, ProfileDeviceEvent, ProfileProgramEvent
from tinygrad.sunnypilot.modeld_v3.ops import sym_infer, sint, Variable, UOp
from tinygrad.sunnypilot.modeld_v3.runtime.autogen import libc
...
class HCQCompiled(Compiled, Generic[SignalType]):
  ...
  def __init__(self, device:str, allocator:HCQAllocatorBase, renderer:Renderer, compiler:Compiler, runtime, signal_t:Type[SignalType],
    ...
    from tinygrad.sunnypilot.modeld_v3.runtime.graph.hcq import HCQGraph
