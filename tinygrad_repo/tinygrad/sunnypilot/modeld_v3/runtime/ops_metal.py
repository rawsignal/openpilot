...
from tinygrad.sunnypilot.modeld_v3.helpers import prod, to_mv, getenv, round_up, cache_dir, T, init_c_struct_t, PROFILE
from tinygrad.sunnypilot.modeld_v3.device import Compiled, Compiler, CompileError, LRUAllocator, cpu_profile, ProfileDeviceEvent, ProfileRangeEvent
from tinygrad.sunnypilot.modeld_v3.renderer.cstyle import MetalRenderer
...
class MetalDevice(Compiled):
  def __init__(self, device:str):
    ...
    from tinygrad.sunnypilot.modeld_v3.runtime.graph.metal import MetalGraph
