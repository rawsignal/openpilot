...
from tinygrad.sunnypilot.modeld_v3.device import BufferSpec, Compiled, Allocator, Compiler, MallocAllocator
from tinygrad.sunnypilot.modeld_v3.dtype import dtypes, DType, PtrDType
from tinygrad.sunnypilot.modeld_v3.ops import Ops, UOp
from tinygrad.sunnypilot.modeld_v3.helpers import from_mv, getenv, round_up, mv_address, to_mv, cpu_objdump, DEBUG
from tinygrad.sunnypilot.modeld_v3.renderer.cstyle import ClangRenderer
from tinygrad.sunnypilot.modeld_v3.runtime.autogen import libc, qcom_dsp
...
class DSPDevice(Compiled):
  def __init__(self, device:str=""):
    ...
    try:
      ...
      from tinygrad.sunnypilot.modeld_v3.runtime.graph.cpu import CPUGraph
