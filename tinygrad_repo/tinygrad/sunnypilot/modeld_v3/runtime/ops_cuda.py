...
from tinygrad.sunnypilot.modeld_v3.helpers import DEBUG, getenv, from_mv, init_c_var, init_c_struct_t
from tinygrad.sunnypilot.modeld_v3.device import Compiled, BufferSpec, LRUAllocator
from tinygrad.sunnypilot.modeld_v3.renderer.cstyle import CUDARenderer
from tinygrad.sunnypilot.modeld_v3.renderer.ptx import PTXRenderer
from tinygrad.sunnypilot.modeld_v3.runtime.autogen import cuda
from tinygrad.sunnypilot.modeld_v3.runtime.support.compiler_cuda import cuda_disassemble, pretty_ptx, CUDACompiler, PTXCompiler, PTX
...
class CUDADevice(Compiled):
  ...
  def __init__(self, device:str):
    ...
    from tinygrad.sunnypilot.modeld_v3.runtime.graph.cuda import CUDAGraph
