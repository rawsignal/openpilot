...
from tinygrad.sunnypilot.modeld_v3.helpers import CI, OSX, LRU, getenv, diskcache_get, diskcache_put, DEBUG, GlobalCounters, flat_mv, from_mv, PROFILE, temp, mv_address, \
                             cpu_time_execution, colored, Context, round_up
from tinygrad.sunnypilot.modeld_v3.dtype import DType, ImageDType, PtrDType, dtypes, _to_np_dtype
...
if PROFILE:
  ...
  def finalize_profile():
    ...
    if not getenv("SQTT", 0):
      from tinygrad.sunnypilot.modeld_v3.ops import launch_viz
