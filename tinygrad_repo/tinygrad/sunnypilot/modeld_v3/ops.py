...
from tinygrad.sunnypilot.modeld_v3.dtype import ConstType, ImageDType, dtypes, DType, truncate
from tinygrad.sunnypilot.modeld_v3.helpers import ContextVar, all_int, prod, getenv, all_same, Context, partition, temp, unwrap, T, argfix, Metadata, _METADATA, flatten
from tinygrad.sunnypilot.modeld_v3.helpers import PICKLE_BUFFERS, dedup, cdiv, cmod
if TYPE_CHECKING:
...
class UOp(MathTrait, metaclass=UOpMetaClass):
  ...
  def simplify(self):
    # late import!
    from tinygrad.sunnypilot.modeld_v3.codegen.symbolic import symbolic
