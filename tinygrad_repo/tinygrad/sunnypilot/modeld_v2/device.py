...
from tinygrad.sunnypilot.modeld_v2.helpers import CI, OSX, getenv, diskcache_get, diskcache_put, DEBUG, GlobalCounters, flat_mv, from_mv, PROFILE, temp
from tinygrad.sunnypilot.modeld_v2.dtype import DType, ImageDType, PtrDType, dtypes
from tinygrad.sunnypilot.modeld_v2.renderer import Renderer
from tinygrad.sunnypilot.modeld_v2.ops import UOp, buffers
...
class _Device:
  ...
  def __get_canonicalized_item(self, ix:str) -> Compiled:
    ...
    x = ix.split(":")[0].upper()
    ret = [cls for cname, cls in inspect.getmembers(importlib.import_module(f'tinygrad.sunnypilot.modeld_v2.runtime.ops_{x.lower()}')) \
...
if PROFILE:
  ...
  def finalize_profile():
    ...
    from tinygrad.sunnypilot.modeld_v2.ops import launch_viz
