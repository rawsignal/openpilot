...
import traceback
import numpy as np
from tinygrad.sunnypilot.modeld_v2.runtime.ops_gpu import CLProgram, compile_gpu
...
from tinygrad.sunnypilot.modeld_v2.runtime.ops_gpu import OSX_TIMING_RATIO
CL = Device["GPU"]
