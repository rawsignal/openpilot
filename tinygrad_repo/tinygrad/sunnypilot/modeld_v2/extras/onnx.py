...
import numpy as np
from tinygrad.sunnypilot.modeld_v2 import Tensor, dtypes
from tinygrad.sunnypilot.modeld_v2.helpers import getenv, DEBUG, all_same
from tinygrad.sunnypilot.modeld_v2.dtype import DType, ConstType
from tinygrad.sunnypilot.modeld_v2.device import is_dtype_supported
from onnx import AttributeProto, ModelProto, TensorProto, ValueInfoProto
try:
  from tinygrad.sunnypilot.modeld_v2.extras.helper import tensor_dtype_to_np_dtype
except ImportError:
  # for onnx < 1.13
...
onnx_ops = importlib.import_module(f'tinygrad.sunnypilot.modeld_v2.extras.onnx_ops')
