...
from tinygrad.sunnypilot.modeld_v2.helpers import PROFILE, from_mv, getenv, to_mv, round_up
from tinygrad.sunnypilot.modeld_v2.renderer import Renderer
from tinygrad.sunnypilot.modeld_v2.device import BufferSpec, Compiler, Compiled, LRUAllocator, ProfileRangeEvent, ProfileDeviceEvent
from tinygrad.sunnypilot.modeld_v2.ops import sym_infer, sint, Variable
...
class HCQCompiled(Compiled, Generic[SignalType]):
  ...
  def __init__(self, device:str, allocator:HCQAllocatorBase, renderer:Renderer, compiler:Compiler, runtime, signal_t:Type[SignalType],
    ...
    from tinygrad.sunnypilot.modeld_v2.runtime.graph.hcq import HCQGraph
