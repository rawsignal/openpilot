...
from tinygrad.sunnypilot.modeld_v2.helpers import prod, to_mv, getenv, round_up, cache_dir, T, init_c_struct_t, PROFILE
from tinygrad.sunnypilot.modeld_v2.device import Compiled, Compiler, CompileError, LRUAllocator, cpu_profile, ProfileDeviceEvent, ProfileRangeEvent
from tinygrad.sunnypilot.modeld_v2.renderer.cstyle import MetalRenderer
...
class MetalDevice(Compiled):
  def __init__(self, device:str):
    ...
    from tinygrad.sunnypilot.modeld_v2.runtime.graph.metal import MetalGraph
