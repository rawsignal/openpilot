...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"VibePersonalityEnabled", {PERSISTENT, BOOL, "0"}},
    {"VibeAccelPersonalityEnabled", {PERSISTENT, BOOL, "0"}},
    {"VibeFollowPersonalityEnabled", {PERSISTENT, BOOL, "0"}},
    ...
    {"DynamicExperimentalDistanceValue", {PERSISTENT | BACKUP, STRING, "30"}},
    {"DynamicExperimentalSpeedBased", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DynamicExperimentalSpeedValue", {PERSISTENT | BACKUP, STRING, "25"}},
