...
static const std::vector<ParamConfig> PARAM_CONFIGS = {
  ...
  {"LongTuningUpperJerkV", QObject::tr("Upper Jerk Values"), QObject::tr("Acceleration  jerk limits by speed (m/s³). Format: 2.0,2.0,1.2"), "2.0,2.0,1.2", 0.5f, 3.0f, 0.0f, true},
  {"LongTuningLowerJerkV", QObject::tr("Lower Jerk Values"), QObject::tr("Braking jerk limits by speed (m/s³). Format: 3.0,3.0,2.5"), "3.0,3.0,2.5", 1.5f, 5.0f, 0.0f, true}
};
